		...
		IMP.request_pay({
		    ...
		    if ( rsp.success ) {
		        ...
		        location.href = 'memberPaymentSuccess.do?siteId='+bookingInfo.siteId+'&campId='+bookingInfo.campId+'&phone='+bookingInfo.phone+
		    		...
		    		'&nights='+bookingInfo.nights+'&days='+bookingInfo.days+'&useMile='+bookingInfo.useMile
		    } else {
		        var msg = '결제에 실패하였습니다.';
		        ...
		        location.href = 'memberGetOneSiteInfo.do?siteId='+bookingInfo.siteId+'&campId='+bookingInfo.campId+
		        		...
		        		'&price='+bookingInfo.sitePrice+'&type='+bookingInfo.type+'&useMile='+bookingInfo.useMile
