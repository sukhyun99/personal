						...
						<div class="col-md-12">
							...
							<div class="content">
								<div id="menu1" class="tab-pane fade in active">
									...
									<div class="row">
										<table class="table booking-list table-bordered" id="member-list">
											<thead>
												<tr id="foo">
													<th>번호</th>
													<th>아이디</th>
								...
								<table class="table table-bordered" >
									...
									<tbody>
										<tr>
											...
											<td>111-222</td>
											<td style="color: MediumSeablue; font-weight: bolder">전다혜</td>
											<td>갱아지캠핑장</td>
											<td>방가로</td>
											<td>2018-08-21</td>
											<td>1박2일</td>
...
<!--modal  -->
<div class="container">
		<div class="modal fade" id="detailModal2" role="dialog">
			<div class="modal-dialog modal-lg">
	...
	$("#review").click(function(){
		...
		$(function() {
			...
			if(bookingList == null || bookingList == "")
				...
				$('#member-list').append(trHtml);
				
				});
				var member_detail = $('.member-detail');
					member_detail.attr('type', 'submit').attr('data-toggle', 'modal')
