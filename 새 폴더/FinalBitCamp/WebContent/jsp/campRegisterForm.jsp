	...
	<div class="container"> 
		<div class="stepwizard col-md-offset-3">
			...
			<form role="form" action="" method="post">
				<div class="row col-md-offset-3 setup-content" id="step-1"> 
					<div class="col-md-10 col-md-offset-2">
							<h3 class="col-md-6 _mt-40">약관동의</h3>
						<div class="col-md-12">
						...
						<div class="btn-area col-md-8 _mt-40">
			...
			<div class="row setup-content" id="step-2">
				<div class="col-xs-6 col-md-offset-3">
					<div class="col-md-12">
						...
						<div class="col-xs-12 col-md-offset-1">
							<label class="control-label">아이디</label> <input maxlength="200"
								type="text" class="form-control" />&ensp;
						</div>
						<div class="col-xs-12 col-md-offset-1">
						...
						<div class="col-xs-12 col-md-offset-1">
							<label class="control-label">비밀번호</label> <input maxlength="200"
								type="password" class="form-control" />&ensp;
						</div>
						<div class="col-xs-12 col-md-offset-1">
							<label class="control-label">비밀번호 확인</label> <input
								maxlength="200" type="password" class="form-control" />&ensp;
						</div>
						<div class="col-xs-12 col-md-offset-1">
					...
					<div class="btn-area col-md-12 _mt-40">
						<button class="btn btn-primary nextBtn btn-lg pull-right"
							type="button" style="margin-bottom: 80px; margin-top: 30px">Next</button>
					</div>
...
<!-- 								style="margin-bottom: 100px;" type="submit">메인으로 돌아가기</button> -->
						</div>
					</div>
					<button class="btn btn-primary nextBtn btn-lg pull-right"
						type="button" style="margin-bottom: 80px; margin-top: 30px">Next</button>
