							...
							<div class="theme-account-preferences">
											...
											<div class="collapse" id="ChangePassword">
												<div class="theme-account-preferences-item-change">
													...
													<div class="form-group theme-account-preferences-item-change-form">
														...
														<label>변경할비밀번호</label> 
														<input id="pwNew" class="form-control" type="password" /> 
														<label>비밀번호 확인	</label>
								...
								<div class="theme-account-preferences-item">
									<div class="row">
										...
										<div class="col-md-7 ">
											<p id="email" class="theme-account-preferences-item-value">dahye950824@gamail.com
												</p>
											<div class="collapse" id="ChangeHomeSite">
												<div class="theme-account-preferences-item-change">
													<p class="theme-account-preferences-item-change-description">수정	</p>
													<div class="form-group theme-account-preferences-item-change-form">
														<input class="form-control" type="text"	value="dahye950824@gamail.com" />
													</div>
													<div class="theme-account-preferences-item-change-actions">
								...
								<div class="theme-account-preferences-item">
									<div class="row">
										...
										<div class="col-md-7 ">
											<p id="tel" class="theme-account-preferences-item-value">02-456-789</p>
											<div class="collapse" id="ChangeLanguage">
												<div class="theme-account-preferences-item-change">
												<p class="theme-account-preferences-item-change-description">수정	</p>
													<div class="form-group theme-account-preferences-item-change-form">
														<input class="form-control" type="text"	value="02-456-789" />
													</div>
													<div class="theme-account-preferences-item-change-actions">
														<a class="btn btn-sm btn-primary" href="#">Save changes</a> 
								...
								<div class="theme-account-preferences-item">
									<div class="row">
										...
										<div class="col-md-7 ">
											<p id="addr" class="theme-account-preferences-item-value">서울시 서대문구 홍제동</p>
											<div class="collapse" id="ChangeTemp">
												<div class="theme-account-preferences-item-change">
												<p class="theme-account-preferences-item-change-description">수정</p>
													<div class="form-group theme-account-preferences-item-change-form">
														<input class="form-control" type="text" value="03214" />
															<input class="form-control" type="text" value="서울시 서대문구 홍제동" />
													</div>
													<div class="theme-account-preferences-item-change-actions">
														<a class="btn btn-sm btn-primary" href="#">Save changes</a> 
