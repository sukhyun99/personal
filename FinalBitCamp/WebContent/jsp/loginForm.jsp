          ...
          <div class="collapse navbar-collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="nav-item" id="loginList">
                    <a class="nav-link" id="login" href="loginForm.do">로그인</a>
              	</li>
            </ul>
          </div>
        </div>
                ...
                <div class="theme-login-box-inner">
                  ...
                  <div class="theme-login-social-login"> 
                    <div class="row" data-gutter="10">
                      <div class="col-xs-6">
                        <a class="naverBtn" href="naverLogin.do">
                            <img src="img/naverBtn_2.PNG" style="width: 150px;">
                        </a>
                      </div>
                      <div class="col-xs-6">
                        <a class="kakaoBtn" href="https://kauth.kakao.com/oauth/authorize?client_id=1ac3e7706d2467a442f2585681668ea0&redirect_uri=http://localhost:8080/FinalBitCamp/kakaoLogin.do&response_type=code&scope=account_email">
