	...
	<div class="container">
		<div class="col-md-12">
			<div class="col-sm-6" style="margin-top: 80px;">
				<div class="content1 form-control" style="border: 1px solid lightgrey; height: 200px; background-color: #ffffff;">
					<br>
					<p style="font-size: 20pt;">아이디 찾기</p>
					<div class="col-sm-6">
						<h4>이름 :</h4>
							<input id="inputName" type="text" class="form-control" placeholder="이름">
					</div>
					<div class="col-sm-6">
						<h4>e-mail :</h4>
							<input id="inputEmail" type="text" class="form-control" placeholder="e-mail">
					</div>
				</div>
			</div>
			<div class="col-sm-6" style="margin-top: 80px;">
				<div class="content1 form-control"
					...
					<div class="col-sm-6">
						<h4>아이디 :</h4>
							<input id="inputId" type="text" class="form-control" placeholder="아이디">
					</div>
					<div class="col-sm-6">
						<h4>e-mail :</h4>
							<input id="inputPassEmail" type="text" class="form-control" placeholder="e-mail">
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-12">
			<div class="col-sm-6">
				<input id="idOk" type="button" class="btn btn-primary" style="margin-top: 20px; margin-bottom: 80px;  margin-left: 198px;" value="확인">&ensp;  
				<input type="button" class="btn btn-danger" style="margin-top: 20px; margin-bottom: 80px;" value="취소">
			</div>
			<div class="col-sm-6" >
				<input id="passOk" type="button" class="btn btn-primary" style="margin-top: 20px; margin-bottom: 80px; margin-left: 198px;" value="확인">&ensp; 
				<input type="button" class="btn btn-danger" style="margin-top: 20px; margin-bottom: 80px;" value="취소">
			</div>
		</div>
	</div>
