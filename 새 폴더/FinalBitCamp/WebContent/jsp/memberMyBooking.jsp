				...
				<div class="col-md-2 ">
					<div class="theme-account-sidebar">
						<div class="theme-account-avatar">
							...
							<div class="theme-account-avatar-name">
								${userId } 님<br>마일리지 : ${mileage } 원
							</div>
						</div>
						...
						<nav class="theme-account-nav">
							<ul class="theme-account-nav-list">
								<li class="active">
									<a href="memberMyBooking.do"> <i class="fa fa-history"></i>나의 예약 </a>
								</li>
								<li>
									<a href="#"> <i class="fa fa-bell"></i>내가 작성한 글</a>
								</li>
								<li>
									<a href="#"> <i class="fa fa-bookmark"></i>내가 찜한캠핑장</a>
								</li>
									<li><a href="#"> <i class="fa fa-user-circle-o"></i>내 정보 수정</a>
								</li>
						...
						<div class="row">
							<div class="col-xs-12">
											...
											<td>
												<div class="form-inline">
													<div class="form-group">
														<select class="form-control search-keyword">
										...
										<tr>
											...
											<td>
													<div class="form-inline">
														...
														<input class="form-control datePickerStart _mob-h" value="" type="text">&nbsp;-&nbsp;
												        <input class="form-control datePickerEnd _mob-h" value="" type="text">
													</div>
											</td>
										</tr>						
									</tbody>							
								...
								<div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"
									...
									<button type="button" class="btn btn-primary" id="booking-search"
							...
							<script type="text/javascript">
								...
								$(document).ready(function(){
									$('#booking-search').click(function(){
										...
										var endDate = $('.endPickerStart').val();
										var keyword = $('.search-keyword').val();
										
										$.ajax({
											type : 'get',
											url : 'memberSearchMyBooking.do',
											dataType : 'json',
											success : function(data){
												alert("데이터:"+data);
											},
											erro : function(XhrReq,status,error){
												alert(status);
												alert(error);
											}
										})
...
// 					console.log("인덱스뭘까:"+index+",아이템뭘까:"+item.bookingNum);
...
<!-- 	<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDYeBBmgAkyAN_QKjAVOiP_kWZ_eQdadeI&callback=initMap&libraries=places"></script> -->
	...
	<script src="js/memberBooking.js"></script>
</body>
</html>