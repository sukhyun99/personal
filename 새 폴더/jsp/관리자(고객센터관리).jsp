					...
					<div class="theme-account-sidebar">
						...
						<ul class="theme-account-nav-list">
							...
							<li class="active"><a href="#"> <i
									class="fa fa-exclamation-circle"></i>고객센터 관리
							</a></li>
									...
									<div class="row">
										<table class="table table-bordered">
											<tbody>
												...
												<tr>
												<th>평점</th>
												 <td><input type="radio" name="radiobtn" value="star">&ensp;<span style="color:orange"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></span>
												 &ensp; <input type="radio" name="radiobtn" value="star">&ensp;<span style="color:orange"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></span>
												  &ensp; <input type="radio" name="radiobtn" value="star">&ensp;<span style="color:orange"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i></span>
												   &ensp; <input type="radio" name="radiobtn" value="star">&ensp;<span style="color:orange"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i></span>
													 &ensp; <input type="radio" name="radiobtn" value="star">&ensp;<span style="color:orange"><i class="fa fa-star"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i><i class="fa fa-star-o"></i></span></td>
