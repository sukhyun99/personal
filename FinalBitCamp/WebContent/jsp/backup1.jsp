...
//     		$(".theme-search-results-item-preview").append('<a class="theme-search-results-item-mask-link" href="#searchResultsItem-" role="button" aria-expanded="false" aria-controls="searchResultsItem-"></a>'
...
// 							+ '<div class="col-md-9 ">'														
// 							+ '<h5 id="campName" class="theme-search-results-item-title theme-search-results-item-title-lg">코코비발디 글램핑</h5>'
...
// 							+ '<i class="fa fa-map-marker"></i>강원도</p>'
// 							+ '</div>'
// 							+ '<div class="col-md-3 ">'
...
// 							+ '</div>'							
// 							+ '</div>')
//     		$(".theme-search-results-item-title-lg").text(item.campName);    		
//     	})
									...
									<div
										...
										<div class="theme-search-area-section-inner">
											...
											<input class="theme-search-area-section-input"
												id="guest" value="4 Guests" type="text" />
