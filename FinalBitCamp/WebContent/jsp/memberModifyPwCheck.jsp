		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9-5 ">
					<div class="container">
						<h2 style="margin-top: 10px;"><b>내 정보 수정 </b></h2>
						<hr class="container">
					</div>
				<div class="form-group" style="text-align: center;">
				<p style="font-size: 2em">비밀번호확인</p>
				<div class="form-group">
				<div class="form-inline">
				<input id="inputPass" type="password" class="form-control" size="30">
				</div>
				</div>
				<a id="passChk" type="button" class="btn btn-primary">확인</a>
				</div>
				</div>
			</div>
		</div>
